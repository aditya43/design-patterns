...
interface State
{
    ...
    /**
     * @return boolean whether a binary string that brought to this State is valid.
     */
 ...
 * when the number of 1's read is even (valid string).
 */
...
/**
 * A ConcreteState. The machine is in this state
 * when the number of 1's read is odd (invalid string).
 */
