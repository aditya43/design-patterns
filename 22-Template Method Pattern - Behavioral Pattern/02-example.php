...
abstract class BinaryOperation
{
     ...
     */
    abstract protected function _getFirstNumber();
    abstract protected function _getSecondNumber();
    abstract protected function _operator($a, $b);
...
echo $nonNegativeSubtraction->getOperationResult(), "<br />";
